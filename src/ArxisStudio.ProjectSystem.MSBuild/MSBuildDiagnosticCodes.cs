...
/// <c>APS1xxx</c>, running targets rather than evaluating them is <c>APS3xxx</c> in
/// <see cref="OperationDiagnosticCodes"/>, package management owns <c>APS4xxx</c>, and
/// <c>APS5xxx</c> belongs to the adapters.
/// </para>
/// <para>
